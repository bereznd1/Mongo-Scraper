...
app.get("/scrape", function(req, res) {
    ...
    request("https://www.nytimes.com/section/arts/music?action=click&contentCollection=arts&region=navbar&module=collectionsnav&pagetype=sectionfront&pgtype=sectionfront", function(error, response, html) {
